...
async function main() {
  ...
  passFactory = await ethers.getContractFactory("TabbitPass");
  pass = await passFactory.deploy();
  await pass.deployed();
  console.log("TabbitPass Deployed at:", pass.address);

  ticketFactory = await ethers.getContractFactory("TabbitTicket");
