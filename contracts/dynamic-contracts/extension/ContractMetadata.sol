...
import "../../extention/interface/IContractMetadata.sol";

/**
 *  @title   Contract Metadata
 *  @notice  This `ContractMetadata` is a contract extension for any base contracts. It lets you set a metadata URI
 *           for you contract.
